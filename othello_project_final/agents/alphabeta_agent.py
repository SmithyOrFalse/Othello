...
AlphaBetaAgent
--------------
Equivalent to MinimaxAgent but with Alpha-Beta Pruning to reduce the number
of nodes visited. This agent always produces the same move and value as
Minimax — it is simply faster.
...
class AlphaBetaAgent:
    ...
    # ------------------------------------------------------------------ #
    # Evaluation function (identical to MinimaxAgent for equivalence)
    # ------------------------------------------------------------------ #
    def evaluate(self, game, player):
        ...
        Weights shift based on game phase.
        """
        opp = -player
        size = game.size
        board = game.board
        ...
        # Game phase: ratio of filled squares
    ...
    def alphabeta(self, game, depth, alpha, beta, maximizing, root_player):
        """
        Alpha-Beta search. Returns (value, best_move).
        - alpha: best value guaranteed so far for the maximising player.
        - beta:  best value guaranteed so far for the minimising player.
